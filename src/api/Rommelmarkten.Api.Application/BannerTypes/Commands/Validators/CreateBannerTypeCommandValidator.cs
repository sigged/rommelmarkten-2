...
{
    public class CreateBannerTypeCommandValidator : BannerTypeValidatorBase<CreateBannerTypeCommand>
    {
        public CreateBannerTypeCommandValidator(IApplicationDbContext context) : base(context)
        {
            RuleFor(v => v.Id)
