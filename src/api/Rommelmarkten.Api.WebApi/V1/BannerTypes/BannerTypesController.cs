...
using Rommelmarkten.Api.Application.BannerTypes.Commands;
using Rommelmarkten.Api.Application.BannerTypes.Models;
using Rommelmarkten.Api.Application.BannerTypes.Requests;
using Rommelmarkten.Api.WebApi.Controllers;
using Rommelmarkten.Api.WebApi.Middlewares;
using System.Net.Mime;

namespace Rommelmarkten.Api.WebApi.V1.BannerTypes
{
    [ApiVersion("1.0")]
    [ApiController]
